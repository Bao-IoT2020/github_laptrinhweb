			...
			<div class="row">
				<div class="col-sm-3">
					...
					<div class="brands_products"><!--brands_products-->
							<h2>Danh Mục Sản Phẩm</h2>{{--  (<?php echo count($danhmuc); ?>)	 --}}
					...
					<!--thuonghieu-->
						<div class="brands_products"><!--brands_products-->
							<h2>Thương Hiệu Sản Phẩm</h2> {{--  (<?php echo count($thuonghieu); ?>)	 --}}
			   ...
			   <div class="features_items"><!--features_items-->
				   <h2 class="title text-center">Sản Phẩm Được Tìm kiếm (<?php echo count($search_product); ?>) </h2> 
			   @foreach($search_product as $keys => $sp)
